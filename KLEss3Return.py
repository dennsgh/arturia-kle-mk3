...
class KLEssReturn:
    ...
    def init(self) :
        ...
        ### PAD LED ###
        send_to_device(bytes([0x04, 0x01, 0x16, eLedIds.eLedPad1BankA, 0x00, 0x00, 0x16]))
        send_to_device(bytes([0x04, 0x01, 0x16, eLedIds.eLedPad2BankA, 0x00, 0x08, 0x16]))
        send_to_device(bytes([0x04, 0x01, 0x16, eLedIds.eLedPad3BankA, 0x00, 0x16, 0x16]))
        send_to_device(bytes([0x04, 0x01, 0x16, eLedIds.eLedPad4BankA, 0x08, 0x16, 0x16]))
        send_to_device(bytes([0x04, 0x01, 0x16, eLedIds.eLedPad5BankA, 0x16, 0x16, 0x08]))
        send_to_device(bytes([0x04, 0x01, 0x16, eLedIds.eLedPad6BankA, 0x16, 0x16, 0x00]))
        send_to_device(bytes([0x04, 0x01, 0x16, eLedIds.eLedPad7BankA, 0x16, 0x08, 0x00]))
        send_to_device(bytes([0x04, 0x01, 0x16, eLedIds.eLedPad8BankA, 0x16, 0x00, 0x00]))

        send_to_device(bytes([0x04, 0x01, 0x16, eLedIds.eLedPad1BankB, 0x00, 0x00, 0x16]))
        send_to_device(bytes([0x04, 0x01, 0x16, eLedIds.eLedPad2BankB, 0x00, 0x08, 0x16]))
        send_to_device(bytes([0x04, 0x01, 0x16, eLedIds.eLedPad3BankB, 0x00, 0x16, 0x16]))
        send_to_device(bytes([0x04, 0x01, 0x16, eLedIds.eLedPad4BankB, 0x08, 0x16, 0x16]))
        send_to_device(bytes([0x04, 0x01, 0x16, eLedIds.eLedPad5BankB, 0x16, 0x16, 0x08]))
        send_to_device(bytes([0x04, 0x01, 0x16, eLedIds.eLedPad6BankB, 0x16, 0x16, 0x00]))
        send_to_device(bytes([0x04, 0x01, 0x16, eLedIds.eLedPad7BankB, 0x16, 0x08, 0x00]))
        send_to_device(bytes([0x04, 0x01, 0x16, eLedIds.eLedPad8BankB, 0x16, 0x00, 0x00]))
    ...
    def RecordReturn(self) :
        if transport.isRecording() :
            ...
            send_to_device(bytes([0x04, 0x01, 0x16, eLedIds.eLedRecord, 0x00, 0x10, 0x00]))
